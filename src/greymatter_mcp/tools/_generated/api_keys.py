...
def register(mcp: FastMCP, *, read_only: bool) -> None:
    ...
    # apiKeys (query) — GraphQL operation, tool name "api_keys"
    ...
    if not read_only:
        ...
        # createApiKey (mutation) — GraphQL operation, tool name "create_api_key"
        ...
        # deleteApiKeyById (mutation) — GraphQL operation, tool name "delete_api_key_by_id"
        ...
        # deleteApiKeys (mutation) — GraphQL operation, tool name "delete_api_keys"
